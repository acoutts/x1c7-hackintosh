 ...
 *
 * Disassembly of SSDT-3-SaSsdt.aml, Wed Jan  1 07:06:53 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000330A (13066)
 *     Revision         0x02
 *     Checksum         0xE2
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0xB9956018, 0x01F4)
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        {
            If (LNotEqual (CLID, \_SB.LID._LID ()))
            {
                VLOC (\_SB.LID._LID ())
            }
            ...
            If (LEqual (NDID, One))
            {
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMP1, Zero))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x02))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMP2, One))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x03))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMP3, 0x02))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x04))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMP4, 0x03))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x05))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMP5, 0x04))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x06))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMP6, 0x05))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x07))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMP7, 0x06))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x08))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMP8, 0x07))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x09))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMP9, 0x08))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x0A))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMPA, 0x09))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x0B))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMPB, 0x0A))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x0C))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMPC, 0x0B))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x0D))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMPD, 0x0C))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x0E))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMPE, 0x0D))
                }
                Else
                {
            ...
            If (LEqual (NDID, 0x0F))
            {
                ...
                If (LEqual (IPTP, One))
                {
                    Store (0x00023480, Index (TMPF, 0x0E))
                }
                Else
                {
