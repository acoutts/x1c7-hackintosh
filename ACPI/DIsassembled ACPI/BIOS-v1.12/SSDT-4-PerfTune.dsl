 ...
 *
 * Disassembly of SSDT-4-PerfTune.aml, Thu Jan  2 10:21:08 2020
 *
                ...
                If (LEqual (Arg0, 0x05))
                {
                    Return (Package (0x02)
                    {
                        ...
                        Buffer (0x68)
                        {
                            ...
                            /* 0008 */  0x4C, 0x04, 0x00, 0x00, 0x4C, 0x04, 0x00, 0x00,
                            ...
                            /* 0030 */  0x46, 0x05, 0x00, 0x00, 0x46, 0x05, 0x00, 0x00,
                            /* 0038 */  0x78, 0x05, 0x00, 0x00, 0x78, 0x05, 0x00, 0x00,
                            ...
                            /* 0060 */  0x72, 0x06, 0x00, 0x00, 0x72, 0x06, 0x00, 0x00 
                        }
                    })
                }
                ...
                If (LEqual (Arg0, 0x49))
                {
                    Return (Package (0x02)
                    {
                        ...
                        Buffer (0x10)
                        {
                            ...
                            /* 0008 */  0x01, 0x00, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00 
                        }
                    })
                }
