 ...
 *
 * Disassembly of SSDT-0-CpuSsdt.aml, Wed Jan  1 07:06:53 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "CpuSsdt", 0x00003000)
{
    ...
    {
        Name (CTPC, Zero)
        OperationRegion (PNVS, SystemMemory, 0xB9D50000, 0x0071)
    ...
    Scope (\_SB.PR00)
    {
        ...
        Method (GCAP, 1, Serialized)
        {
            ...
            If (LAnd (LOr (And (CFGD, One), And (CFGD, 0x00400000)), LNot (And (SDTL, 0x0100))))
            {
                Or (SDTL, 0x0100, SDTL)
    ...
    Scope (\_SB.PR01)
    {
        ...
        {
            If (LAnd (LOr (And (CFGD, One), And (CFGD, 0x00400000)), LNot (And (SDTL, 0x0200))))
            {
                Or (SDTL, 0x0200, SDTL)
