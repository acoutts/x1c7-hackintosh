 ...
 *
 * Disassembly of SSDT-8-UsbCTabl.aml, Thu Jan  2 10:21:08 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000EF6 (3830)
 *     Revision         0x02
 *     Checksum         0x2B
 *     OEM ID           "LENOVO"
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "UsbCTabl", 0x00001000)
{
    ...
    External (TUP1, MethodObj)    // 1 Arguments (from opcode)
    External (TUP2, MethodObj)    // 1 Arguments (from opcode)
